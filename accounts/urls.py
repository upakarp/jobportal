...
urlpatterns = [
    ...
    url(r'^profile/(?P<pk>\d+)/d$', views.view_profile, name='profile_with_pk'),
    ...
    url(r'^reset-password/confirm/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$', password_reset_confirm, {'template_name':'accounts/reset_password_confirm.html',
